        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 space-y-10 text-slate-300">
          ...
          <div className="space-y-6 text-sm">
            ...
            <div className="space-y-2">
              ...
              <p className="leading-relaxed">
                Should you wish to close your administrative account, clean historic lead databases from active instances, or deactivate missed-call SMS loops, please communicate direct requests to Matthew or Heather Eisan.
              </p>
            </div>
          </div>
